package io.maestro.plugins.postgres.execution
        ...
        return jdbi.withHandle<WorkflowExecution?, Exception> { handle ->
            ...
            """.trimIndent())
                ...
                .map { rs, _ ->
                    ...
                    WorkflowExecution(
                        executionId = WorkflowExecutionID.fromString(rs.getString("execution_id")),
                        ...
                        startedAt = rs.getObject("started_at", Instant::class.java),
                        completedAt = rs.getObject("completed_at", Instant::class.java),
                        lastUpdatedAt = rs.getObject("last_updated_at", Instant::class.java)
                    )
                }
                .findFirst()
                .orElse(null)
