...
interface IWorkflowRevisionRepository {
     ...
     * @throws io.maestro.core.workflow.WorkflowAlreadyExistsException if revision already exists
     */
     ...
     * @throws io.maestro.core.workflow.WorkflowNotFoundException if revision doesn't exist
     * @throws io.maestro.core.workflow.ActiveRevisionConflictException if revision is active
     */
